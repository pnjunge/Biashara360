...
@Composable fun HospitalityOperationsScreen(client:HttpClient=koinInject()){
 val scope=rememberCoroutineScope();var data by remember{mutableStateOf<Operations?>(null)};var error by remember{mutableStateOf<String?>(null)};var loading by remember{mutableStateOf(false)}
