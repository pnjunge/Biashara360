...
@Serializable data class UpdateHospitalityTableRequest(val name: String, val area: String = "Main Floor", val capacity: Int = 4)
@Serializable data class HospitalityTableResponse(val id: String, val name: String, val area: String, val capacity: Int, val status: String, val openOrderId: String? = null, val openAmount: Double = 0.0, val openOrderCount: Int = 0,val waiterUserId:String?=null,val mergedIntoTableId:String?=null,val positionX:Int=0,val positionY:Int=0,val shape:String="RECTANGLE")
@Serializable data class HospitalityOrderRequest(val tableId: String? = null, val serviceType: String = "DINE_IN", val guestCount: Int = 1, val customerName: String = "Walk-in Guest", val customerPhone: String = "", val notes: String = "", val ageVerified:Boolean=false, val items: List<OrderItemRequest>)
