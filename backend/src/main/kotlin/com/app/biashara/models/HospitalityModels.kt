...
@Serializable data class HospitalityTableResponse(val id: String, val name: String, val area: String, val capacity: Int, val status: String, val openOrderId: String? = null, val openAmount: Double = 0.0, val openOrderCount: Int = 0)
